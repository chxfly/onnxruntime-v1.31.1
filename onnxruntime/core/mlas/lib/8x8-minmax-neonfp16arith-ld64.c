...
//copied from XNNPack's src/f16-gemm/gen/8x8-minmax-neonfp16arith-ld64.c
//Still need clean up
...
void xnn_f16_gemm_minmax_ukernel_8x8__neonfp16arith_ld64(
    ...
    size_t cm_stride,
    size_t cn_stride,
    const union xnn_f16_minmax_params params[1])
{
  assert(mr != 0);
  assert(mr <= 8);
  assert(nc != 0);
  assert(kc != 0);
  assert(kc % sizeof(float16_t) == 0);
  assert(a != NULL);
  assert(w != NULL);
  assert(c != NULL);

  const float16_t* a0 = (const float16_t*) a;
  float16_t* c0 = (float16_t*) c;
  const float16_t* a1 = (const float16_t*) ((uintptr_t) a0 + a_stride);
  float16_t* c1 = (float16_t*) ((uintptr_t) c0 + cm_stride);
  if (mr < 2) {
    a1 = a0;
    c1 = c0;
  }
  const float16_t* a2 = (const float16_t*) ((uintptr_t) a1 + a_stride);
  float16_t* c2 = (float16_t*) ((uintptr_t) c1 + cm_stride);
  if (mr <= 2) {
    a2 = a1;
    c2 = c1;
  }
  const float16_t* a3 = (const float16_t*) ((uintptr_t) a2 + a_stride);
  float16_t* c3 = (float16_t*) ((uintptr_t) c2 + cm_stride);
  if (mr < 4) {
    a3 = a2;
    c3 = c2;
  }
  const float16_t* a4 = (const float16_t*) ((uintptr_t) a3 + a_stride);
  float16_t* c4 = (float16_t*) ((uintptr_t) c3 + cm_stride);
  if (mr <= 4) {
    a4 = a3;
    c4 = c3;
  }
  const float16_t* a5 = (const float16_t*) ((uintptr_t) a4 + a_stride);
  float16_t* c5 = (float16_t*) ((uintptr_t) c4 + cm_stride);
  if (mr < 6) {
    a5 = a4;
    c5 = c4;
  }
  const float16_t* a6 = (const float16_t*) ((uintptr_t) a5 + a_stride);
  float16_t* c6 = (float16_t*) ((uintptr_t) c5 + cm_stride);
  if (mr <= 6) {
    a6 = a5;
    c6 = c5;
  }
  const float16_t* a7 = (const float16_t*) ((uintptr_t) a6 + a_stride);
  float16_t* c7 = (float16_t*) ((uintptr_t) c6 + cm_stride);
  if (mr != 8) {
    a7 = a6;
    c7 = c6;
  }
  ...
  do {
    ...
    if (nc >= 8) {
      ...
      c0 = (float16_t*) ((uintptr_t) c0 + cn_stride);
      vst1q_f16(c1, vacc1x01234567);
      c1 = (float16_t*) ((uintptr_t) c1 + cn_stride);
      vst1q_f16(c2, vacc2x01234567);
      c2 = (float16_t*) ((uintptr_t) c2 + cn_stride);
      vst1q_f16(c3, vacc3x01234567);
      c3 = (float16_t*) ((uintptr_t) c3 + cn_stride);
      vst1q_f16(c4, vacc4x01234567);
      c4 = (float16_t*) ((uintptr_t) c4 + cn_stride);
      vst1q_f16(c5, vacc5x01234567);
      c5 = (float16_t*) ((uintptr_t) c5 + cn_stride);
      vst1q_f16(c6, vacc6x01234567);
      c6 = (float16_t*) ((uintptr_t) c6 + cn_stride);
      vst1q_f16(c7, vacc7x01234567);
      c7 = (float16_t*) ((uintptr_t) c7 + cn_stride);

      a0 = (const float16_t*) ((uintptr_t) a0 - kc);
      a1 = (const float16_t*) ((uintptr_t) a1 - kc);
      a2 = (const float16_t*) ((uintptr_t) a2 - kc);
      a3 = (const float16_t*) ((uintptr_t) a3 - kc);
      a4 = (const float16_t*) ((uintptr_t) a4 - kc);
      a5 = (const float16_t*) ((uintptr_t) a5 - kc);
      a6 = (const float16_t*) ((uintptr_t) a6 - kc);
      a7 = (const float16_t*) ((uintptr_t) a7 - kc);
