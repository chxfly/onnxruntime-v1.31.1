...
activities = [
    ...
    ('non-zero', lambda x : any(substr in x for substr in ['NonZero', 'write_indices'])),
    ...
    ('where', lambda x : any(substr in x for substr in ['onnxruntime::cuda::_TenaryElementWise', 'kernelPointwiseApply2<TensorMaskedFillOp', 'masked_fill_kernel', 'where_kernel_impl'])),
